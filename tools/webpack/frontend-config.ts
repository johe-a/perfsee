...
import { PerfseePlugin } from '@johfe/perfsee-webpack'
...
export function getFrontendConfig() {
  const pkg = getPackage('@johfe/perfsee-platform')
  return {
    resolve: {
    ...
    plugins: [
      ...
      new webpack.DefinePlugin({
        ...
        LOCAL_REPORT: false,
        PERFSEE_PLATFORM_HOST: `"${
          process.env.PERFSEE_PLATFORM_HOST_FOR_FRONTEND ?? process.env.PERFSEE_PLATFORM_HOST ?? ''
        }"`,
