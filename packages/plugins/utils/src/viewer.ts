...
import { BundleResult, calcBundleScore, ModuleReasons, ModuleTreeNode } from '@johefe/perfsee-bundle-analyzer'

export const PACKAGE_NAME = '@johefe/perfsee-plugin-utils'
