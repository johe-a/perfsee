...
import { BundleResult, calcBundleScore, ModuleReasons, ModuleTreeNode } from '@johfe/perfsee-bundle-analyzer'

export const PACKAGE_NAME = '@johfe/perfsee-plugin-utils'
