...
import { PackageBundleResolver, PackageResolver, ProjectPackagesResolver } from './resolver'
...
@Module({
  ...
  providers: [PackageService, ProjectPackagesResolver, PackageResolver, PackageBundleResolver],
