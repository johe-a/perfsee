...
import { dynamicImport, logger } from '@johfe/perfsee-job-runner-shared'
...
export async function WhiteScreen() {
  ...
  return class extends Audit {
    ...
    static audit(artifacts: LH.PerfseeArtifacts): Promise<LH.Audit.Product> {
